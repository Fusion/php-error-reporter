...
// Really? A good exception == a way to pop up several levels...
// You do _not_ have to use that!
...
$str = <<<EOB
function displayMessageNow(type, message)
{
	switch(type)
	{
	...
	if(window.displayMessage)
		displayMessage(); // This last one exists in the view
}
EOB;
addjs($str);
